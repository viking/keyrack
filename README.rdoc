...
The first time you run Keyrack, it will present you with a series of prompts.
You can specify the <b>-d</b> option if you want Keyrack to put its files somewhere
other than <b>~/.keyrack</b>.
